    ...
    &&  isset($_POST['ciudad']) &&  isset($_POST['estado'])&&  isset($_POST['direccion'])){
        ...
        if($_POST['pass'] == $_POST['pass2'] ){
            ...
            $pass=sha1($_POST['pass']);
                $conexion->query("insert into usuario (nombre,Apellido,telefono,ciudad,estado,direccion, email,password,nivel) 
                    values('$name','$Apellido','$telefono','$ciudad','$estado','$direccion','$email','$pass','cliente')  ")or die($conexion->error);
