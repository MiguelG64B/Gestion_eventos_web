  ...
  <div class="wrapper fadeInDown">
    ...
    <div id="formContent">
      ...
      <form action="./php/inicio.php" method="post">
        <input type="text" id="correo" class="fadeIn second" name="correo" placeholder="email">
        <input type="password" id="contrasena" class="fadeIn third" name="contrasena" placeholder="password">
